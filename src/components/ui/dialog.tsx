...
function DialogContent({
  ...
  const sizeClasses = {
    default: "sm:max-w-lg",
    lg: "sm:max-w-2xl",
    xl: "sm:max-w-5xl lg:max-w-7xl",
    full:
      "w-screen h-screen max-w-none max-h-none top-0 left-0 translate-x-0 translate-y-0 rounded-none sm:rounded-none",
  }
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[95vw] " +
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center sm:text-left cursor-pointer", className)}
      {...props}
    />
  )
}
